...
biomassBS = (mean_gm2*9.0e+9)/1.0e+6 %  area of Bransfield survey
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% AMLR03 70 kHz all data biomass
% load penguin conversion factors 
load('C:\Github\AMLR23-24_acoustics\data\CF_2023-24_penguin.mat')
...
% load gridded data
load('C:\Github\AMLR23-24_acoustics\data\AMLR03\70kHz\gridded_AMLR03_2023-24_70kHz_5m.mat')
...
%% AMLR03 120 kHz all data biomass
...
% load gridded data
load('C:\Github\AMLR23-24_acoustics\data\AMLR03\120kHz\gridded_AMLR03_2023-24_120kHz_5m.mat')
...
%% AMLR04 70 kHz all data biomass
...
% load gridded data
load('C:\Github\AMLR23-24_acoustics\data\AMLR04\70kHz\gridded_AMLR04_2023-24_70kHz_5m.mat')
...
%% AMLR04 120 kHz all data biomass
clear
...
% load gridded data
load('C:\Github\AMLR23-24_acoustics\data\AMLR04\120kHz\gridded_AMLR04_2023-24_120kHz_5m.mat')
